...
Информация отправляется в собственную базу данных или в телеграмм группу.
...
Бот задаёт 5-7 вопросов, запоминая ответы.
После последнего вопроса предлагает оставить телефон/e-mail.
Информация может отправляться в собственную базу данных, на почту или в телеграмм группу.
"""
...
При необходимости связывается с базой данных, где фиксируются данные пользователей.
"""
...
Интеграция с базой данных, почтой или телеграмм группой.
"""
...
✅ Интегрироваться с базой данных и другими сервисами
"""
